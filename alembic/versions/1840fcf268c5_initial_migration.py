...
Revision ID: 1840fcf268c5
Revises: 
Create Date: 2024-05-26 04:13:57.527526
...
def downgrade() -> None:
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['portfolio_id'], ['portfolio.id'], name='trade_portfolio_id_fkey'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['owner_id'], ['user.id'], name='portfolio_owner_id_fkey'),
